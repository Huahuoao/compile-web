...
public class BasicController {
    ...
    public String reset() throws Exception {
        ...
        return CmdUtils.readFileAsString("grammar_init.txt");
    }
...
//            basicService.handleCode();
            // 读取文件内容
            List<String> actions = Files.readAllLines(Paths.get("C:\\compile\\action.txt"));
            List<String> stacks = Files.readAllLines(Paths.get("C:\\compile\\stack.txt"));
            // 构建结果列表
